  ...
  return (
    <section className="relative w-full py-16 bg-brand-dark">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Section Title */}
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600 drop-shadow-sm">
          抽奖活动说明。
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 bg-brand-card rounded-xl border border-white/5 p-8 relative overflow-hidden hover:border-white/10 transition-colors group">
          ...
          {/* Card 2: Process */}
          <div className="bg-brand-card rounded-xl border border-white/5 p-8 relative overflow-hidden hover:border-white/10 transition-colors">
            <h3 className="text-2xl font-bold text-red-500 mb-6">抽奖过程</h3>
            <ul className="space-y-3 text-slate-300">
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-slate-500 rounded-full mt-2.5 mr-3 shrink-0"></span>
          ...
          {/* Card 3: Claim Prize */}
          <div className="bg-brand-card rounded-xl border border-white/5 p-8 relative overflow-hidden hover:border-white/10 transition-colors">
            <h3 className="text-2xl font-bold text-red-500 mb-6">领取奖品</h3>
            <ul className="space-y-3 text-slate-300">
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-slate-500 rounded-full mt-2.5 mr-3 shrink-0"></span>
        ...
        <div className="mt-20 text-center relative z-10">
            ...
            <p className="text-red-500 font-medium py-4 text-lg">
