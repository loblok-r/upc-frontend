                                    ...
                                    <div className="mt-auto pt-2 border-t border-white/5">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <button
                                                ...
                                                disabled={!isLoggedIn || loadingIds[product.id]}
                                            ...
                                            >
                                                {!isLoggedIn ? '请先登录' : loadingIds[product.id] ? (
                                        ...
                                        <div className="flex-1 flex flex-col justify-between">
                                            ...
                                            <div className="flex justify-between items-end">
                                                ...
                                                <button
                                                    ...
                                                    disabled={!isLoggedIn || item.status === 'ended' || item.status === 'upcoming' || loadingIds[item.id]}
                                                ...
                                                >
                                                    {!isLoggedIn ? '需登录' : loadingIds[item.id] ? (
